...
class MainWindow(QMainWindow):
    ...
    def _build_composer(self) -> QFrame:
        ...
        for key, feature in FEATURE_MODES.items():
            ...
            feature_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        ...
        attach_btn.setToolTip("Attach files for Gemini")
        ...
        paste_image_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        ...
        send_btn.setToolTip("Send message to Gemini")
        ...
        stop_btn.setToolTip("Stop the current agent task")
